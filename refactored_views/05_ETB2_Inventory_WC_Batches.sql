...
-- ============================================================================
-- FG SOURCE (PAB-style): Derive FG from ETB_PAB_MO via Lot Number linkage
-- Lot Numbers often contain order references that link to MO data
-- ============================================================================
FG_From_MO AS (
    SELECT
        m.ORDERNUMBER,
        ...
        -- Extract potential lot/order references from ORDERNUMBER
        UPPER(
            REPLACE(
                REPLACE(
                    REPLACE(
...
InventoryWithFG AS (
    SELECT
        ...
        -- Priority: Direct lot match > Order substring match
        fg.FG_Item_Number,
        fg.FG_Description,
        fg.Construct,
        ROW_NUMBER() OVER (
