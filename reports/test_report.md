...
|-----------|------------------|---------------------|--------------|-----------|
| 1.1 WC Demand Deprecation | dbo.Rolyat_WC_Allocation_Effective_Demand_2 | Demands within window with WC inventory but not suppressed | 0 rows | PASS |
| 1.2 WC Demand Deprecation | dbo.Rolyat_WC_Allocation_Effective_Demand_2 | Demands outside window incorrectly suppressed | 0 rows | PASS |
| 3.1 Inventory Degradation | dbo.Rolyat_WC_Allocation_Effective_Demand_2 | Incorrect degradation factors | 0 rows | PASS |
| 4.1 No Double Allocation | dbo.Rolyat_WC_Allocation_Effective_Demand_2 | Allocated quantity exceeds batch effective qty | 0 rows | PASS |
...
| dbo.Rolyat_WC_Allocation_Effective_Demand_2 | PASS | Inventory matching, degradation, allocation logic, effective demand, window enforcement | None identified |
