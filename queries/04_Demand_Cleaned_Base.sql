...
SELECT 
    ...
    SUM(TRY_CAST(d.Deductions AS DECIMAL(18,2))) AS Quantity,  -- Deductions column represents demand quantity
...
WHERE TRY_CAST(d.Deductions AS DECIMAL(18,2)) > 0            -- Only demand events (Deductions > 0)
    AND TRY_CAST(d.Deductions AS DECIMAL(18,2)) IS NOT NULL   -- Exclude invalid numeric values
